...
if(!function_exists( 'startit_qode_styles' )) {
    ...
    function startit_qode_styles() {
        ...
        if(startit_qode_is_responsive_on()) {
	        ...
	        if ( file_exists(QODE_ROOT_DIR . "/css/style_dynamic_responsive.css") && startit_select_is_css_folder_writable() && !is_multisite()){
		        wp_enqueue_style("startit-qode-style-dynamic-responsive", QODE_ASSETS_ROOT . "/css/style_dynamic_responsive.css", array(), filemtime(QODE_ROOT_DIR . "/css/style_dynamic_responsive.css"));
	        } else if ( file_exists( QODE_ROOT_DIR . '/style_dynamic_responsive_ms_id_' . startit_select_get_multisite_blog_id() . '.css' ) && startit_select_is_css_folder_writable() && is_multisite() ) {

		        wp_enqueue_style( 'startit-qode-style-dynamic-responsive', QODE_ASSETS_ROOT . '/css/style_dynamic_responsive_ms_id_' . startit_select_get_multisite_blog_id() . '.css', array(), filemtime( QODE_ROOT_DIR . '/css/style_dynamic_responsive_ms_id_' . startit_select_get_multisite_blog_id() . '.css' ) );
	        } else {
	    ...
	    if ( file_exists(QODE_ROOT_DIR . "/css/style_dynamic.css") && startit_select_is_css_folder_writable() && !is_multisite()) {
		    wp_enqueue_style("startit-qode-style-dynamic", QODE_ASSETS_ROOT . "/css/style_dynamic.css", $style_dynamic_deps_array, filemtime(QODE_ROOT_DIR . "/css/style_dynamic.css") ); //it must be included after woocommerce styles so it can override it
	    } else if ( file_exists( QODE_ROOT_DIR . '/style_dynamic_ms_id_' . startit_select_get_multisite_blog_id() . '.css' ) && startit_select_is_css_folder_writable() && is_multisite() ) {
		    wp_enqueue_style( 'startit-qode-style-dynamic', QODE_ASSETS_ROOT . '/css/style_dynamic_ms_id_' . startit_select_get_multisite_blog_id() . '.css', array(), filemtime(QODE_ROOT_DIR . '/css/style_dynamic_ms_id_' . startit_select_get_multisite_blog_id() . '.css') );
	    } else {
