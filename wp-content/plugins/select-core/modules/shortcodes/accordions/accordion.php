...
class Accordion implements ShortcodeInterface{
	...
	public function vcMap() {
		...
		vc_map( array(
			'name' =>  esc_html__( 'Select Accordion', 'startit-core' ),
			'base' => $this->base,
			...
			'params' => array(
				array(
					'type' => 'textfield',
					'heading' => esc_html__( 'Extra class name', 'startit-core' ),
					'param_name' => 'el_class',
					'description' => esc_html__( 'Style particular content element differently - add a class name and refer to it in custom CSS.', 'startit-core' )
				),
				array(
					'type' => 'dropdown',
					'class' => '',
